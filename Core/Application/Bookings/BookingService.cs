...
namespace HotelManagement.Core.Application.Bookings;
...
public sealed class BookingService : IBookingService
{
    ...
    public async Task<BookingResponse> GetByIdAsync(int id)
    {
        var booking = await _context.Bookings
                          ...
                          .FirstOrDefaultAsync()
                      ?? throw new NotFoundException(nameof(Models.Bookings.Bookings), id);
    ...
    private static BookingResponse ToResponse(Models.Bookings.Bookings b) =>
